...
module.exports = async (on, config) => {
  ...
  on('after:run', async (results) => {
    ...
    const reportContainer = blobServiceClient.getContainerClient("ezpay-checkout-svc-cypress-report");
    ...
    if (results) {
      ...
      await axios.post("https://apteanonline.webhook.office.com/webhookb2/b879817b-ffa3-404c-8f59-37ecabce0a54@560ec2b0-df0c-4e8c-9848-a15718863bb6/IncomingWebhook/2764818da21b4aca81dffb801f2da179/a7c163f2-fcf7-4365-a94c-6d9bf23155cc", {      
          ...
          "themeColor": "0076D7",
          "summary": "Ezpay Checkout Services Cypress Test Result",
          "sections": [{
              "activityTitle": title,
              "activitySubtitle": "On Ezpay Checkout Services",
              "facts": [],
              "markdown": true
          }],
          "potentialAction": [{
              ...
              "targets": [{
                  "os": "default",
                  "uri": `https://stcypressdev001.blob.core.windows.net/ezpay-checkout-svc-cypress-report/${dateSubFolder}/index.html`
              }]
          }]
      });
    }
